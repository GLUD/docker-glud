...
$CFG->dbhost    = getenv('DB_TCP_ADDR');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('DB_ENV_DATABASE');     // database name, eg moodle
$CFG->dbuser    = getenv('DB_ENV_USER');   // your database username
$CFG->dbpass    = getenv('DB_ENV_PASSWORD_FILE') ? exec('tail -n1 $DB_ENV_PASSWORD_FILE') : getenv('DB_ENV_PASSWORD');   // your database password
...
$CFG->dboptions = array(
    ...
    'dbport'    => getenv('DB_TCP_PORT'),          // the TCP port number to use when connecting
